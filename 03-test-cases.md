...
- Шаги:
1. Ввести заблокированный `Usename` (`locked_out_user`)
2. Ввести валидный `Password`
3. Нажать `Login`
...
4. Подтвердить заказ путем нажания на кнопку `Finish`
...
Шаги:
1. Оставить обязательное поле пустыми
